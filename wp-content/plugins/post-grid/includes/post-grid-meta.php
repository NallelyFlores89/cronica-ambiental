		...
		<ul class="box">
            <li style="display: block;" class="box1 tab-box active">
				...
				<div class="option-box">
                    ...
                    <option value="load_more" <?php if($post_grid_pagination_display=="load_more")echo "selected"; ?>>Load More</option>
				...
				<div class="option-box">
                    ...
                    <br><br>
                    In Mobile & Tabs: <br>
					<input type="text" placeholder="ex: 250px" size="10"  name="post_grid_items_width_mobile" value="<?php if(!empty($post_grid_items_width_mobile))echo $post_grid_items_width_mobile; ?>" />     
...
?>
            ...
            <li style="display: none;" class="box3 tab-box ">
				...
				<div class="option-box">
                    ...
                    <div class="expandable">
                    	...
                    	<div class="items">
                        <div class="header"><?php _e('Post Taxonomy & Catgory','post_grid'); ?></div>
                        <div class="options">
                                ...
                                if(!empty($post_grid_taxonomies))
                                    {
                                        foreach ($post_grid_taxonomies as $taxonomy ) {
                                          ...
                                          <label ><input type="radio" class="post_grid_taxonomy" name="post_grid_taxonomy" value="<?php echo $taxonomy; ?>" <?php if($post_grid_taxonomy==$taxonomy)  echo "checked";?> /><?php echo $taxonomy; ?></label><br />
                    	...
                    	<div class="items">
                            ...
                            <input type="text" placeholder="5,3" name="post_grid_exclude_post_id" value="<?php if(!empty($post_grid_exclude_post_id)) echo $post_grid_exclude_post_id; else echo ''; ?>" /> 
            ...
            <li style="display: none;" class="box4 tab-box "> 
				...
				<div class="option-box">
                    ...
                    <p class="option-info"></p>
					<input type="text" size="5"  name="post_grid_mixitup_post_per_page" value="<?php if(!empty($post_grid_mixitup_post_per_page))echo $post_grid_mixitup_post_per_page; else echo 6; ?>" />                   
                </div>
...
function meta_boxes_post_grid_save( $post_id ) {
  ...
  // Sanitize user input.
	...
	$post_grid_exclude_post_id = sanitize_text_field( $_POST['post_grid_exclude_post_id'] );				
	...
	if(empty($_POST['post_grid_taxonomy']))
		{
			$_POST['post_grid_taxonomy'] = '';
		}
	if(empty($_POST['post_grid_taxonomy_category']))
		{
			$_POST['post_grid_taxonomy_category'] = '';
		}	
	
	
	$post_grid_taxonomy = sanitize_text_field( $_POST['post_grid_taxonomy'] );
	$post_grid_taxonomy_category = stripslashes_deep( $_POST['post_grid_taxonomy_category'] );	
	...
	$post_grid_mixitup_post_per_page = sanitize_text_field( $_POST['post_grid_mixitup_post_per_page'] );
	$post_grid_mixitup_default_filter = sanitize_text_field( $_POST['post_grid_mixitup_default_filter'] );	
  ...
  // Update the meta field in the database.
	...
	update_post_meta( $post_id, 'post_grid_exclude_post_id', $post_grid_exclude_post_id );	
	...
	update_post_meta( $post_id, 'post_grid_taxonomy', $post_grid_taxonomy );
	update_post_meta( $post_id, 'post_grid_taxonomy_category', $post_grid_taxonomy_category );		
	...
	update_post_meta( $post_id, 'post_grid_mixitup_post_per_page', $post_grid_mixitup_post_per_page );	
	update_post_meta( $post_id, 'post_grid_mixitup_default_filter', $post_grid_mixitup_default_filter );		
