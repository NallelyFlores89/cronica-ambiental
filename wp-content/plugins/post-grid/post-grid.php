...
class PostGrid{
	...
	public function __construct(){
		...
		define('post_grid_customer_type', 'pro' );	 // pro & free
		...
		define('POST_GRID_SPECIAL_SECRET_KEY', '54ea2b2dded527.18658902'); 
		define('POST_GRID_LICENSE_SERVER_URL', 'http://paratheme.com'); 
		define('POST_GRID_ITEM_REFERENCE', 1008);
		define('POST_GRID_LICENSE_KEYS_PAGE', 'http://paratheme.com/license-keys/');
