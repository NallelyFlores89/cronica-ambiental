...
function minimagazine_related_posts() {
	...
	echo '<section id="relatedArticles" class="clearfix"><header><h2>'.__('Artículos relacionados','minimagazine').'</h2></header>';
	...
	while ( $the_query->have_posts() ) : $the_query->the_post();
			...
			<article>
				...
				<h3 class="title title_articulos_relacionados"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h3>
			</article>
